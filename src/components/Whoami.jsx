...
const Whoami = () => {
  return (
    <div className="space-y-2 flex flex-col items-start">
        ...
        <p>Currently, I’m diving headfirst into <strong>Computer Engineering</strong> at the University of Bologna, after surviving (and graduating with honors!) high school in Computer Science and Telecommunications.</p>
